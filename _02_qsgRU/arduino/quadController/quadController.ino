...
void loop()
{
  ...
  if(currentMillis > nextExecuteMillis) {  
    ...
    for(pin = 0; pin < TOTAL_ANALOG_PINS; pin++) {
      ...
      if(analogValue < previousAnalogValues[pin]-4 || analogValue > previousAnalogValues[pin]+4) {
        //Serial.print(previousAnalogValues[pin],4);
        //analogValue = map(analogValue, 0, 1023, 1, 0);
